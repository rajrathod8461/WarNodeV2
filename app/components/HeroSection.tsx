                ...
                {[...partners, ...partners].map((partner, index) => (
                  ...
                  >
                    <Image
                      ...
                      width={160}
                      height={64}
                      className={`h-12 sm:h-14 w-auto min-w-[88px] max-w-[160px] object-contain transition-all duration-300 ${
                        partner.colored
                          ? "opacity-70 grayscale hover:opacity-100 hover:grayscale-0 dark:opacity-90"
                          : "opacity-60 grayscale hover:opacity-100 hover:grayscale-0 dark:opacity-90 dark:brightness-0 dark:invert"
                      }`}
                      loading="lazy"
                      quality={75}
