---
name: ui-ux-pro-max
description: Generates tailored design systems and UI/UX recommendations for web, mobile, and desktop apps. Use when building, designing, reviewing, or improving UI — landing pages, dashboards, components, dark mode, accessibility, typography, colors, or stack-specific guidance (Next.js, React, Tailwind, shadcn/ui).
---
# ui-ux-pro-max
...
- **Stack**: Next.js, React, Tailwind CSS, shadcn/ui (this project's stack)
...
| Stack | Focus |
|-------|-------|
| `nextjs` | App Router, RSC, routing, metadata, performance |
| `react` | Components, hooks, performance, state |
| `shadcn` | Radix primitives, theming, accessible components |
| `html-tailwind` | Utility-first layout, responsive design, tokens |

**This project (Next.js + shadcn) examples:**

```bash
python .cursor/skills/ui-ux-pro-max/scripts/search.py "responsive layout dark mode" --stack nextjs
python .cursor/skills/ui-ux-pro-max/scripts/search.py "form validation dialog" --stack shadcn
python .cursor/skills/ui-ux-pro-max/scripts/search.py "hero section spacing" --stack html-tailwind
```
...
```bash
python .cursor/skills/ui-ux-pro-max/scripts/search.py "layout performance navigation" --stack nextjs
```
...
- Default icon library for this project: **Lucide (`lucide-react`)**. `data/icons.csv` lists common recommendations, not the full set.
- When a recommended icon is missing, pick any semantically better icon from Lucide's full set.
- Fallback: **Heroicons (`@heroicons/react`)** — keep stroke weight and style consistent.

| Rule | Standard | Avoid | Why It Matters |
|------|----------|--------|----------------|
| **No Emoji as Structural Icons** | Use vector icons (e.g., Lucide `lucide-react`, Heroicons `@heroicons/react`). | Using emojis (🎨 🚀 ⚙️) for navigation, settings, or system controls. | Emojis are font-dependent, inconsistent across platforms, and cannot be controlled via design tokens. |
